      ...
      <div className="grid gap-4">
        {myMarkets.map((m) => {
          ...
          return (
            <div
              key={slab}
              className="rounded-xl border border-[#1e2433] bg-[#0f1118] p-6"
            >
              ...
              <div className="flex items-center gap-3">
                <Link
                  href={`/trade/${slab}`}
                  className="rounded-lg border border-[#1e2433] px-4 py-2 text-sm font-medium text-slate-300 transition-colors hover:bg-[#1e2433] hover:text-white"
                >
                  Trade →
                </Link>
                <button
